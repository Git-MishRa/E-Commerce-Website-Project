      ...
      <div className="content">
        <form onSubmit={e => e.preventDefault()}>
          ...
          <div className="form-control">
            <h5>Company</h5>
            <select
              name='company' value={company} className='company' onChange={updateFilters}>
          ...
          <div className="form-control">
            ...
            <input type="checkbox" name="shipping" onChange={updateFilters} id='shipping' checked={shipping} />
          </div>
          {/* ------------------------------------------------- */}
